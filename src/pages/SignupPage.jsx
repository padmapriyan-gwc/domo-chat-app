  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between px-12 py-14">
          ...
          <div>
            ...
            <p className="text-white/60 text-base leading-relaxed max-w-sm">
              Create an account and bring your whole team together
          ...
          <div className="border-l-2 border-white/30 pl-4">
            <p className="text-white/70 text-sm italic leading-relaxed">
              "The fastest way to keep everyone on the same page."
            </p>
            <p className="text-white/40 text-xs mt-1">— Built for modern teams</p>
          </div>
      ...
      <div className="w-full md:w-[480px] flex flex-col justify-center
                      px-8 md:px-14 bg-white overflow-y-auto">
        ...
        {/* Heading */}
        <div className="mb-8 py-10 md:py-0">
          ...
          <div>
            ...
            {form.confirm && (
              <p className="text-xs mt-1 font-medium"
                style={{ color: form.password === form.confirm ? '#34d399' : '#f87171' }}>
        ...
        {/* Login link */}
        <p className="text-center text-sm text-gray-500 pb-10 md:pb-0">
          Already have an account?{' '}
          <Link
            to="/login"
            className="text-purple-600 font-semibold hover:text-purple-700transition-colors">
            Log In
          </Link>
        </p>
