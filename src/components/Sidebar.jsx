...
export const Sidebar = ({ activeRoomId, onSelectRoom, onNewChat, onNewGroup }) => {
  ...
  const getRoomInitial = (room) => getRoomLabel(room)[0]?.toUpperCase() || '?';
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl
                                ...
                                ${activeRoomId === room.id
                                  ...
                                  : 'hover:bg-gray-50 text-gray-700'}`}
                  >
                    <div className="w-10 h-10 rounded-full bg-teal-100 text-teal-600
                                    flex items-center justify-center text-sm font-semibold flex-shrink-0">
                      {getRoomInitial(room)}
                    </div>
            ...
            {/* Groups */}
            <div className="px-3 pt-4">
              <p className="text-xs text-gray-400 font-medium px-2 mb-1">Groups</p>
              {groups.length === 0 ? (
                <p className="text-xs text-gray-300 px-2 py-2">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl
                                ...
                                ${activeRoomId === room.id
                                  ...
                                  : 'hover:bg-gray-50 text-gray-700'}`}
                  >
                    <div className="w-10 h-10 rounded-full bg-purple-100 text-purple-600
                                    flex items-center justify-center text-sm font-semibold flex-shrink-0">
                      {getRoomInitial(room)}
                    </div>
                    <span className="text-sm font-medium truncate">
